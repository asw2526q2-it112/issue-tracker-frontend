...
export function IssueListView() {
    ...
    const { data: issuesData, isLoading: issuesLoading } = useIssues({
        ...
        priority: priId,
        status: statId,
        ordering: toOrdering(sortField, sortDir), // ← string, como espera tu hook
        page,
    });
    ...
    // Los settings devuelven PaginatedXList; extraemos .results
        ...
        <div className="p-8">
            ...
            <div className="mb-6 flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <Button variant="ghost" size="icon" asChild title="Bulk insert issues">
                        <Link href="/bulk-new/">
            ...
            <div className="flex items-start">
                {/* Sidebar filtros */}
                <div
                    className={`grid overflow-hidden transition-[grid-template-columns,opacity,margin] duration-300 ease-in-out ${showFilters
                            ? "grid-cols-[13rem] opacity-100 mr-5"
                            : "grid-cols-[0rem] opacity-0 mr-0 h-0"
                        }`}
                >
